...
describe('Tooltip', () => {
  it('should pass down all attributes', () => {
    const wrapper = shallow(
      <Tooltip content={content} data-table="true">
        {children}
      </Tooltip>,
    );
  ...
  it('should render content', () => {
    const wrapper = shallow(
      <Tooltip content={content} className="tooly">
        {children}
      </Tooltip>,
    );
  ...
  it('should pass down a className prop', () => {
    const wrapper = shallow(
      <Tooltip content={content} className="tooly">
        {children}
      </Tooltip>,
    ...
    expect(wrapper.find('.tooly').exists()).toEqual(true);
  });
