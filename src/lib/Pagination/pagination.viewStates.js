export const getLastChunkPage = (
  pagesLeft,
  { activePage, chunkSize, totalPages, isMobile },
) => {
...
export const getFirstChunkPage = (
  pagesLeft,
  { activePage, totalPages, chunkSize, isMobile },
) => {
  let firstChunkPage;
  ...
  if (activePage <= chunkSize) {
    ...
    firstChunkPage = isMobile
      ? activePage - (Math.ceil(chunkSize / 2) - 1)
      : totalPages - chunkSize - 1;
  } else {
